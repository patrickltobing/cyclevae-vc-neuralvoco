        ...
        if (header.format_type == 1 && header.channels == 1) { // PCM and mono
            ...
            if (argc == 3) { //analysis-synthesis
                ...
                for (i = 0, j = 0, k = 0; i < num_samples; i++) {
                    ...
                    if (read == 1) {
                        ...
                        if (waveform_buffer_flag) {
                            ...
                            mwdlp16net_synthesize(net, features, pcm, &n_output, 0);
                ...
                if (!waveform_buffer_flag && j > 0) {
                    ...
                    mel_spec_extract(dsp, features);
                    mwdlp16net_synthesize(net, features, pcm, &n_output, 0); //last_frame, synth pad_right
                    ...
                    mwdlp16net_synthesize(net, features, pcm, &n_output, 1); //synth pad_right
                    if (n_output > 0)  {
                        fwrite(pcm, sizeof(pcm[0]), n_output, fout);
                        samples += n_output;
                ...
                MWDLP16CycleVAEMelspExcitSpkNetState *net;
                ...
                for (i = 0, j = 0, k = 0; i < num_samples; i++) {
                    ...
                    if (read == 1) {
                        ...
                        if (waveform_buffer_flag) {
                            ...
                            cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 0);
                            //cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 0, 0);
                            //cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 0, melsp_cv);
                            //cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 0, melsp_cv, lat_tmp, spk_tmp, conv_tmp, gru_tmp, f0_tmp);
                            //cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 0, melsp_cv, pcm_1, pcm_2, pcm_3, pcm_4);
                            //printf("cv synth\n");
                        ...
                        fclose(fout);
                        dspstate_destroy(dsp);
                        mwdlp16cyclevaenet_destroy(net);
                        exit(1);
                    }
                }
                //fclose(tmp_file);
                ...
                if (!waveform_buffer_flag && j > 0) {
                    ...
                    mel_spec_extract(dsp, features);
                    cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 0); //last_frame, synth pad_right
                    //cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 0, 0); //last_frame, synth pad_right
                    //cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 0, melsp_cv); //last_frame
                    //cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 0, melsp_cv, lat_tmp, spk_tmp, conv_tmp, gru_tmp, f0_tmp); //last_frame
                    ...
                    cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 1); //synth pad_right
                    //cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 1, 0); //synth pad_right
                    //cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 1, melsp_cv); //synth pad_right
                    //cyclevae_melsp_excit_spk_convert_mwdlp16net_synthesize(net, features, spk_code_aux, pcm, &n_output, 1, melsp_cv, lat_tmp, spk_tmp, conv_tmp, gru_tmp, f0_tmp); //synth pad_right
                    if (n_output > 0)  {
                        fwrite(pcm, sizeof(pcm[0]), n_output, fout);
                        samples += n_output;
                    //    printf("write pad_right %d\n", samples);
