#ifndef MWDLP16NET_CYCVAE_PRIVATE_H
#define MWDLP16NET_CYCVAE_PRIVATE_H
...
//PLT_Dec20
struct MWDLP16CycleVAEPostMelspExcitSpkNetState {
    MWDLP16NNetState nnet;
