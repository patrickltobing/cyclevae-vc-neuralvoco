...
./bin/test_cycvae_mwdlp ${spk_id} ${in_dir}/${in_file}.wav ${out_dir}/${out_name_a}.wav
./bin/test_cycvae_mwdlp ${x_coord} ${y_coord} ${in_dir}/${in_file}.wav ${out_dir}/${out_name_b}.wav
#./bin/test_cycvae_mwdlp.exe ${spk_id} ${in_dir}/${in_file}.wav ${out_dir}/${out_name_a}.wav
#./bin/test_cycvae_mwdlp.exe ${x_coord} ${y_coord} ${in_dir}/${in_file}.wav ${out_dir}/${out_name_b}.wav
