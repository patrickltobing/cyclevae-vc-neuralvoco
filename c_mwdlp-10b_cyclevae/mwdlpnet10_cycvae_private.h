...
because the small GRU-32 directly outputs 32-level classification, i.e., of sqrt(1024).
Hence, it is much faster than the 16-bit coarse-fine or even the 9-bit mu-law architectures,
which needs one last FC-layer for each samples that takes a lot of computational cost.
*/
