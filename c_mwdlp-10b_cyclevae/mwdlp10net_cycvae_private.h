...
POST_CONV_KERNEL,
NB_IN_DEC_EXCIT, NB_IN_DEC_MELSP, NB_IN_POST,
...
#define FEATURE_N_SPK_2_LAT_DIM_EXCIT_MELSP (FEATURE_N_SPK + FEATURE_N_SPK_LAT_DIM_EXCIT_MELSP)

#define FEATURE_1_CAP_DIM (1 + FEATURE_CAP_DIM)
#define FEATURE_2_1_CAP_DIM (2 + FEATURE_1_CAP_DIM)

#define FEATURE_N_SPK_2_2_LAT_DIM_EXCIT_MELSP (2 + FEATURE_N_SPK_2_LAT_DIM_EXCIT_MELSP)
#define FEATURE_N_SPK_2_DIM_EXCIT_MELSP (FEATURE_N_SPK * 2 + 2 + 1 + FEATURE_CAP_DIM + FEATURE_DIM_MELSP)
