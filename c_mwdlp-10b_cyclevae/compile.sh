...
#gcc -mavx2 -mfma -g -O3 -Wall -W -Wextra -fpic -Isrc/ -c src/mwdlp10net_cycvae.c src/freq.c src/nnet.c src/nnet_data.c src/nnet_cv_data.c -lm
#ar rsv libmwdlp10cycvae.a mwdlp10net_cycvae.o freq.o nnet.o nnet_data.o nnet_cv_data.o
#gcc -mavx2 -mfma -g -O3 -Wall -W -Wextra -fpic src/test_mwdlp.c -Isrc/ -L. -lmwdlp10cycvae -lm -o test_mwdlp

gcc -mavx2 -mfma -g -O3 -Wall -W -Wextra -fpic -I. -c mwdlp10net_cycvae.c freq.c nnet.c nnet_data.c nnet_cv_data.c -lm
ar rsv libmwdlp10cycvae.a mwdlp10net_cycvae.o freq.o nnet.o nnet_data.o nnet_cv_data.o
