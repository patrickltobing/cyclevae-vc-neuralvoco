            ...
            for feat_file in feat_list:
                ...
                with torch.no_grad():
                    ...
                    if args.n_interp == 0: # if just reconstructed and conversion
                        ...
                        cvlf0_src, _ = model_decoder_excit(lat_src_e, y=src_code)
                        cvlf0, _ = model_decoder_excit(lat_src_e, y=trg_code)
                        ...
                        pdf, cvmelsp_src_post, _ = model_post(cvmelsp_src, y=src_code_, e=e_post)
                        pdf_cv, cvmelsp_post, _ = model_post(cvmelsp, y=trg_code_, e=e_cv_post)
                        ...
                        cvlf0_cyc, _ = model_decoder_excit(lat_cv_e, y=src_code)
                        ...
                        pdf, cvmelsp_cyc_post, _ = model_post(cvmelsp_cyc, y=src_code, e=e_post)
                ...
                logging.info('org f0')
                logging.info(f0[50:80])
                logging.info('rec f0')
                logging.info(cvf0_src[50:80])
                logging.info('cyc f0')
                logging.info(cvf0_cyc[50:80])
                logging.info('cv f0')
                logging.info(cvf0[50:80])
                logging.info('lin f0')
                logging.info(cvf0_lin[50:80])
                logging.info('org cap')
                logging.info(codeap[50:80])
                logging.info('rec cap')
                logging.info(cvcodeap_src[50:80])
                logging.info('cyc cap')
                logging.info(cvcodeap_cyc[50:80])
                logging.info('cv cap')
                logging.info(cvcodeap[50:80])
