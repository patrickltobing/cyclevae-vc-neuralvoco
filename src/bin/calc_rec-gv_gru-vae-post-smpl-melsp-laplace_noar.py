        ...
        with torch.cuda.device(gpu):
            ...
            with torch.no_grad():
                ...
                for param in model_post.parameters():
                    param.requires_grad = False
            count = 0
            pad_left = model_encoder.pad_left + model_decoder.pad_left + model_post.pad_left
            pad_right = model_encoder.pad_right + model_decoder.pad_right + model_post.pad_right
            ...
            for feat_file in feat_list:
                ...
                with torch.no_grad():
                    ...
                    _, lat_rec, _ = model_encoder(feat, sampling=False)
                ...
                #logging.info(melsp_rec.shape)
                #write_hdf5(feat_file, args.string_path, melsp_rec)
                #logging.info(melsp_res.shape)
                #write_hdf5(feat_file, args.string_path, melsp_res)
                logging.info(melsp_smpl.shape)
