        ...
        with torch.cuda.device(gpu):
            ...
            with torch.no_grad():
                ...
                model_waveform = GRU_WAVE_DECODER_DUALGRU_COMPACT_MBAND_CF(
                    feat_dim=n_spk*2+config.lat_dim+config.lat_dim_e+config.mel_dim,
            ...
            for feat_file in feat_list:
                ...
                with torch.no_grad():
                    ...
                    if args.n_interp == 0: # if just reconstructed and conversion
                        ...
                        cv_samples = model_waveform.generate(lat_cat, spk_code=trg_code, spk_aux=trj_trg_code, aux=cvmelsp,
