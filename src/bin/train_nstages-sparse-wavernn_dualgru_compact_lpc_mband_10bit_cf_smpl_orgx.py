    ...
    while True:
        ...
        if c_idx < 0: # summarize epoch
            ...
            if (not sparse_min_flag and sparse_check_flag) \
                or ((round(float(round(Decimal(str(eval_loss_err_avg)),2))-0.06,2) <= float(round(Decimal(str(min_eval_loss_err_avg)),2))) and \
                    (round(float(round(Decimal(str(eval_loss_l1_avg)),2))-0.04,2) <= float(round(Decimal(str(min_eval_loss_l1_avg)),2))) and \
                    (round(float(round(Decimal(str(eval_loss_l1_fb)),2))-0.04,2) <= float(round(Decimal(str(min_eval_loss_l1_fb)),2))) and \
