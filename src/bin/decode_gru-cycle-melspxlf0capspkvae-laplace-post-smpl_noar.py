            ...
            for feat_file in feat_list:
                ...
                with torch.no_grad():
                    ...
                    if args.n_interp == 0: # if just reconstructed and conversion
                        ...
                        pdf, cvmelsp_post, _ = model_post(cvmelsp, y=trg_code, aux=trj_trg_code, e=e_post)
                        #cvmelsp_post = pdf[:,:,:config.mel_dim]
                        ...
                        pdf, cvmelsp_src_post, _ = model_post(cvmelsp_src, y=src_code, aux=trj_src_code, e=e_post)
                        ...
                        if model_decoder_melsp.pad_right > 0:
                            ...
                            src_code = src_code[:,model_decoder_melsp.pad_left:]
                            trj_src_code = trj_src_code[:,model_decoder_melsp.pad_left:]
                        pdf, cvmelsp_cyc_post, _ = model_post(cvmelsp, y=src_code, aux=trj_src_code, e=e_post)
