...
#define FEATURE_SPK_DIM_2 FEATURE_SPK_DIM * 2
#define FEATURE_SPK_DIM_2_LAT_DIM_EXCIT_MELSP (FEATURE_SPK_DIM_2 + FEATURE_LAT_DIM_EXCIT_MELSP)
...
#define SPK_DEC_MELSP_CONV_KERNEL_1 (SPK_CONV_KERNEL_1 + DEC_MELSP_CONV_KERNEL_1 + 1)
